...
# Change working directory to the project root so that relative paths (e.g., for indexes) are resolved correctly
os.chdir(root_dir)

# Define module build directories relative to the project root
...
print(f"CPP Index Call Build Directory: {index_call_dir}")
print(f"CPP Datetime Parser Build Directory: {datetime_parser_dir}")

# Insert module directories into sys.path so that Python can import them
...
print(f"[i] Current working directory: {os.getcwd()} - Contents: {os.listdir(os.getcwd())}")
