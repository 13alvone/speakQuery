...
cd ~/PycharmProjects/speak-query
...
echo "\n# Please very carefully review the output of the following and ensure that the returned data is what is expected as defined in _test.py.:"
cd ~/PycharmProjects/speak-query/tests
echo "[i] BASH SCRIPT:\n\tcd ~/<project_root>/tests/\n\tcat _test.py"
cat _test.py
echo "[i] BASH COMMAND: python3 _test.py"
python3 _test.py

python3 describe_indexes.py
